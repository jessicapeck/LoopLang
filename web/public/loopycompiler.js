...
continue}}());var
oE=d7,an=[0];function
nU(a,b){if(!a.js_error||b||a[0]===c)a.js_error=new
d.Error("Js exception containing backtrace");return a}function
g(a,b){return d7&&oE?nU(a,b):a}function
...
ch(a,b,c){if(b>>>0>=a.l)nN();return $(a,b,c)}function
...
c=bm.getUint32(0,true),b=bm.getUint32(4,true),d=c&aw,e=c>>>24|b<<8&aw,f=b>>>16&aO;return n9(d,e,f)}function
...
nL=dB;class
hN{constructor(a,b,c,d){this.kind=a;this.layout=b;this.dims=c;this.data=d;this.caml_custom=nL}offset(a){var
c=0;if(typeof
...
f=e1(j),h=nK(l,f),i=hP(l,q,j,h);switch(l){case
2:for(var
...
n2(a,b){if((b&dL)===dL&&(b&0x03ff)!==0)b=0x7c01;else if(b===a5)b=0;return ao(a,b)}function
n3(a,b){var
...
cM={_j:{deserialize:oh,serialize:oc,fixed_length:8,compare:n7,hash:n$},_i:{deserialize:n6,fixed_length:4},_n:{deserialize:ox,fixed_length:4},_bigarray:{deserialize:function(a,b){return hQ(a,b,"_bigarray")},serialize:hT,compare:hO,hash:hS},_bigarr02:{deserialize:function(a,b){return hQ(a,b,dB)},serialize:hT,compare:hO,hash:hS}};function
...
oS(a,b){return a<b?-1:a>b?1:0}function
...
252:if(a!==b){var
d=nO(a,b)|0;if(d!==0)return d}break;case
...
nT(a,b){if(b===0)d6();return a/b|0}function
hY(a,b){return+(dX(a,b,false)===0)}function
nV(a,b,c,d){if(c>0)if(b===0&&(c>=a.l||a.t===2&&c>=a.c.length))if(d===0){a.c=f;a.t=2}else{a.c=bK(c,String.fromCharCode(d));a.t=c===a.l?0:2}else{if(a.t!==4)dY(a);for(c+=b;b<c;b++)a.c[b]=d}return 0}function
fa(a){a=bu(a);var
...
om(a){a=d4(a);if(!fg(a))a=cL+a;var
...
nC(this.nm(a),e,b)}truncate(a,b,c){var
...
hK(he)});function
iq(a){var
g=om(a),a=g.join(bi),f=ih(a),c;for(var
...
ii(a,b){var
a=aD(a),b=bx(b);return nS(a,b)}function
nX(){var
...
n4(a,b){return e5(a,bu(b))}function
n0(a,b){var
...
c==="string"?e5(a,c):n0(a,c)}function
n1(a){a^=a>>>16;a=bZ(a,0x85ebca6b|0);a^=a>>>13;a=bZ(a,0xc2b2ae35|0);a^=a>>>16;return a}function
nY(a,b,c,d){var
...
o=e.length-1<<10|e[0];f=ao(f,o);for(i=1,m=e.length;i<m;i++){if(l>=h)break;j[l++]=e[i]}break}else if(d2(e)){f=nZ(f,e);g--}else if(d3(e)){f=n4(f,e);g--}else if(typeof
e==="string"){f=e5(f,e);g--}else if(e===(e|0)){f=ao(f,e+e+1);g--}else if(typeof
e==="number"){f=h3(f,e);g--}}f=n1(f);return f&0x3fffffff}function
n5(a,b,c){if(!Number.isFinite(a)){if(Number.isNaN(a))return aD(eZ);return aD(a>0?hd:"-infinity")}var
...
n_(a,b){var
c=fa(a);if(c.signedconv&&oa(b)){c.sign=-1;b=od(b)}var
d=f,i=of(c.base),h="0123456789abcdef";do{var
g=b.udivmod(i);b=g.quotient;d=h.charAt(og(g.modulus))+d}while(!ob(b));if(c.prec>=0){c.filler=bq;var
...
cQ(a){var
f=oC(a),d=f[0],i=f[1],g=f[2],j=f[3],h=F(a),k=-1>>>0,e=d<h?a1(a,d):0,c=ia(e);if(c<0||c>=g)aY(dS);var
...
ok(c){return function(...a){a.unshift(this);var
b=cJ(c,a);return b
instanceof
Function?e_(b):b}}function
nJ(a,b){if(a>>>0>=(hg/4|0))cH();var
a=a+1|0,c=new
Array(a);c[0]=0;for(var
d=1;d<a;d++)c[d]=b;return c}function
ci(a,b){return nJ(a,b)}function
nG(){var
a=new
...
oI(a){return cS(a,0,a.length)}function
on(a,b,c){var
d=nG(),e=d_(a);nH(d,e.subarray(b,b+c),c);return oI(nF(d))}function
oo(a,b,c){return on(bk(a),b,c)}function
...
nD(a,b)}d9(a(0,{rdonly:1,altname:"/dev/stdin",isCharacterDevice:true}),0);d9(a(1,{buffered:c?1:2,wronly:1,isCharacterDevice:true}),1);d9(a(2,{buffered:c?1:2,wronly:1,isCharacterDevice:true}),2)}());function
os(a){var
...
ou(a,b,c,d){var
b=d_(b);return ov(a,b,c,d)}function
h8(a,b,c,d){return ou(a,bk(b),c,d)}function
h9(a,b){var
c=bx(String.fromCharCode(b));h8(a,c,0,1);return 0}function
ow(a,b){if(b===0)d6();return a%b}function
bl(a){a=bu(a);var
d=a.length/2,c=new
Array(d);for(var
...
e=a.lex_default_code[l];if(e>0)ol(a.lex_code,e,c[k],c[g]);if(f===bR)c[o]=0}}}function
bw(a,b){return+(dX(a,b,false)!==0)}function
oz(a){return typeof
a==="number"?a:a.slice()}function
oA(a,b){a[0]=dT;a[1]=b;return 0}function
...
a0(a,b,c){if(c){var
d=c;if(io)a=cJ(io,[d]);else if(an.symbols){if(!an.symidx)an.symidx=nM(an.symbols);var
...
oG(){ac(eN)}function
av(a,b){if(b>>>0>=F(a))oG();return a1(a,b)}function
aL(a){a.t&6&&cK(a);return bx(a.c)}function
oK(){return hg/4|0}function
oD(){ib(an.Not_found)}function
ig(a){var
b=ik(d4(a));if(b===undefined)oD();return aD(b)}function
oM(){if(d.crypto)if(d.crypto.getRandomValues){var
...
nW(a){var
b=f;if(a[0]===0){b+=a[1][1];if(a.length===3&&a[2][0]===0&&oj(a[1]))var
g=a[2],h=1;else
var
h=2,g=a;b+="(";for(var
...
e=nW(a),b=cj(gV);if(b)cJ(b,[0]);console.error(eS+e);if(a.js_error)throw a.js_error}}else
throw a}function
oF(){var
c=d.process;if(c?.on)c.on("uncaughtException",function(a,b){hZ(a);c.exit(2)});else if(d.addEventListener)d.addEventListener("error",function(a){if(a.error)hZ(a.error)})}oF();function
...
c=a[1];return[0,c,aF(a[2],b)]}os(0);h7(1);var
aR=h7(2);function
...
ed=oK(0),cn=(4*ed|0)-1|0,iu=[c,"CamlinternalLazy.Undefined",b(0)],iC="List.map2",iD=[0,0,0],iE="String.sub / Bytes.sub",iF="Bytes.blit",iG="String.blit / Bytes.blit_string",iH="String.concat",iI=f,iJ="String.contains_from / Bytes.contains_from";function
fo(a){var
...
bL(a,b){var
c=am(a);nV(c,0,a,b);return c}function
fs(a){var
...
c=jT}return c0(a,n_(c,b))}function
bo(k,b,c){function
l(a){switch(k[1]){case
0:var
d=45;break;case
...
p(a){var
b=nQ(c);return 3===b?c<0.?kn:ko:4<=b?kp:a}switch(k[2]){case
5:var
...
ny=ig(gZ),eo=ny}catch(f){var
fK=a2(f);if(fK!==aQ)throw g(fK,0);try{var
nx=ig("CAMLRUNPARAM"),eo=nx}catch(f){var
fL=a2(f);if(fL!==aQ)throw g(fL,0);var
eo=k6}}var
bM=[hC,function(a){var
m=oM(0),c=[0,ci(55,0),0],i=0===m.length-1?[0,0]:m,j=i.length-1,b=0;for(;;){J(c[1],b)[b+1]=b;var
w=b+1|0;if(54===b)break;b=w}var
h=[0,k5],k=54+fr(55,j)|0,s=0;if(k>=0){var
d=s;for(;;){var
e=d%55|0,l=ow(d,j),t=J(i,l)[l+1],n=h[1]+f+t;h[1]=oo(n,0,F(n));var
...
b4(a,b){return 4<=a.length-1?nY(10,eG,a[3],b)&(a[2].length-2|0):aP(k8)}function
ar(a,b,c){var
...
gs(a,b,c){var
m=c;for(;;){var
d=oy(li,m,b),k=0<=d?1:0,s=k?b[12]!==iM?1:0:k;if(s){b[11]=b[12];var
...
1:var
g=d[1],h=g[2],a=bO(f,e,g[1],h),k=a[3],l=a[1];return[0,[1,[0,l,by(function(a,b){return bD(f,e,a,b)[1]},a[2],h)]],k];case
2:var
i=ah(f,e,[0,c],d[1]);return[0,[2,i[1]],i[2]];case
3:var
j=bC(f,e,4,d[1]);return[0,[3,j[1]],j[2]];default:return[0,[4,es(f,e,d[1])[1]],6]}}function
es(a,b,c){if(0===c[0]){var
d=c[3],p=c[4],q=c[2],e=ah(a,b,l1,c[1]),r=e[2],s=e[1],t=bC(a,b,4,q)[1];if(d)var
f=ah(a,b,l2,d[1]),j=f[2],h=[0,f[1]];else
var
j=0,h=0;if(0!==r)throw g([0,i,l4],1);if(0===j)return[0,[0,s,t,h,p],5];throw g([0,i,l3],1)}var
k=c[3],l=c[1],u=c[4],v=l[2],w=l[1],x=bC(a,b,4,c[2])[1];if(k)var
m=ah(a,b,l5,k[1]),o=m[2],n=[0,m[1]];else
var
o=0,n=0;if(0===o)return[0,[1,[0,w,v],x,n,u],5];throw g([0,i,l6],1)}function
gd(f,d,c){if(0===c[0]){var
a=c[1],h=b6(f,d,l7,a);if(6===h)return[0,[0,a],6];var
n=aT(h);throw g([0,i,G(e(l8),a,n)],1)}var
j=c[1],k=j[2],l=j[1],b=bO(f,d,l,k),m=b[3],o=b[2],p=b[1];if(6===m)return[0,[1,[0,p,by(function(a,b){return bD(f,d,a,b)[1]},o,k)]],6];var
q=aT(m);throw g([0,i,G(e(l9),l,q)],1)}function
...
b=ge(d,e,a),c=b[1];if(5===b[2])return c;throw g([0,i,l_],1)},a[2]);ar(d,G,6);var
...
b=ge(d,e,a),c=b[2],f=b[1];if(5!==c&&6!==c)throw g([0,i,l$],1);return f},j[1])],6]}return[0,[4,k[1]],d,[0,k[2],0]];case
5:var
Z=c[3],_=c[2],M=ah(d,e,ma,c[1]),$=M[1];if(1!==M[2])throw g([0,i,mb],1);var
...
N=c[1],as=c[4],at=c[3],O=ah(d,e,mc,c[2]),au=O[2],av=O[1],P=ah(d,e,md,at),aw=P[2],ax=P[1];if(0!==au)throw g([0,i,mf],1);if(0!==aw)throw g([0,i,me],1);var
Q=c2(d);ar(Q,N,0);var
...
gf=[c,mg,b(0)],aB=[c,mh,b(0)],bP=[c,mi,b(0)],et=[c,mj,b(0)],cr=[c,mk,b(0)],gg=[c,ml,b(0)],b7=bA(0,10),aH=[0,0],aU=[0,1],aC=[0,0],aI=[0,0];function
a4(a){if(typeof
a!=="number"&&0===a[0])return a[1];throw g([0,aB,mm],1)}function
c3(a){if(typeof
a!=="number"&&1===a[0])return a[1];throw g([0,aB,mn],1)}function
gh(a){if(typeof
a!=="number"&&5===a[0])return[0,a[1],a[2]];throw g([0,aB,mo],1)}function
c4(a){if(typeof
a!=="number"&&6===a[0])return a[1];throw g([0,aB,mp],1)}function
mq(a){if(typeof
a!=="number")switch(a[0]){case
5:return[0,[5,a[1],a[2]],0];case
6:return a[1]}throw g([0,aB,mr],1)}function
gi(a){if(typeof
a!=="number")switch(a[0]){case
7:return[0,[7,a[1],a[2],a[3],a[4]],0];case
8:var
b=a[1];return[0,[8,[0,b[1],b[2]],a[2],a[3],a[4]],0];case
9:return a[1]}throw g([0,aB,mt],1)}function
...
5:throw g([0,et,mx],1);default:return[0,0,b]}if(5===c)return[0,b,0];if(c)throw g([0,et,mw],1);return[0,b,0];case
3:var
d=a[2],e=eu(f,a[1]);return[0,bZ(e[1],d),bZ(e[2],d)];case
4:return eu(f,a[1])}throw g([0,aB,mv],1)},aA(function(a){return gh(a)[1]},c4(b)))),c=h[2],e=0,i=h[1];for(;;){if(!c)break;var
...
ev(a){if(!a)return mA;var
b=a[1];if(typeof
b!=="number"&&10===b[0]){var
c=b[1];return l(e(mz),c)}throw g([0,aB,mu],1)}function
cs(a){var
i=0,h=c4(a);for(;;){if(!h)return b0(mQ,cV(i));var
...
b=mJ}var
d=0===k?mL:1===k?b:G(e(mM),b,k);break;case
3:var
l=c[2],n=c[1];if(0===l)var
d=mN;else if(1===l)var
d=cs(n);else
var
p=cs(n),d=G(e(mO),p,l);break;case
4:var
d=cs(c[1]);break;default:break a}if(d===f)var
j=0;else
var
r=ev(q),j=[0,G(e(mP),d,r)];if(j){i=[0,j[1],i];h=m;continue}h=m;continue}}throw g([0,aB,mK],1)}}function
c8(a,b){if(typeof
a!=="number")switch(a[0]){case
7:var
d=a[2],f=a[1],h=ev(a[4]),i=cs(d);return nB(e(mS),f,i,b,h);case
8:var
c=a[1],j=a[2],k=c[2],l=c[1],m=ev(a[4]),n=cs(j);return dy(e(mT),l,k,n,b,m)}throw g([0,aB,mR],1)}function
...
bQ(a,b,c,d){var
e=a9(b7,b),h=e[1],i=e[2],f=bA(0,10);return ct(mV,a,c,function(a){a:{b:{var
...
3:try{var
n=[0,nT(c,d)]}catch(f){var
i=a2(f);if(i===fl)throw g([0,gf,mX],1);throw g(i,0)}return l(b,n);case
4:return l(b,[1,c<d?1:0]);case
5:return l(b,[1,d<c?1:0]);case
6:return l(b,[1,c===d?1:0]);default:throw g([0,aB,mY],1)}}var
e=c3(j),h=c3(a);if(7===f){var
k=e?h:e;return l(b,[1,k])}if(8>f)throw g([0,aB,mW],1);var
m=e||h;return l(b,[1,m])})};break;default:let
c=e,j=d[1];d=d[2];e=function(a){return j?l(c,[1,1-c3(a)]):l(c,[0,-a4(a)|0])}}}function
mU(a,b,c){switch(b[0]){case
0:var
...
0:return ct(mU,a,b[1],function(a){return l(c,[6,cW(aA(mq,a))])});case
1:return l(c,a9(a,b[1]));default:var
...
0:var
n=b[1][1],o=l(e(my),n);aH[1]=[0,o,aH[1]];return l(c,f);case
1:var
...
t=aU[1];throw g([0,bP,G(e(m0),t,h)],1)}var
k=c6(h,s),m=k[2],j=k[1];if(m!==aC[1]){var
u=aC[1];throw g([0,cr,bI(e(m1),h,m,u)],1)}if(1-c7(r,j)){var
v=aI[1];aI[1]=[0,l(e(m2),h),v]}var
w=c8(a,j);aH[1]=[0,w,aH[1]];aC[1]=j;aU[1]=aU[1]+1|0;return l(c,f);case
8:var
n=a[1],i=n[2],b=n[1],x=a[3],y=a[2],z=c5(b),F=h2(i,b);if(1-z){var
A=aU[1];throw g([0,bP,G(e(m3),A,b)],1)}if(1-F)throw g([0,bP,G(e(m4),b,i)],1);if(i>=b){var
d=b;for(;;){var
o=c6(d,y),p=o[2],q=o[1];if(p!==aC[1]){var
C=aC[1];throw g([0,cr,bI(e(m5),d,p,C)],1)}if(1-c7(x,q)){var
D=aI[1];aI[1]=[0,l(e(m6),d),D]}aC[1]=q;var
E=d+1|0;if(i===d)break;d=E}}var
B=c8(a,aC[1]);aH[1]=[0,B,aH[1]];aU[1]=i+1|0;return l(c,f)}throw g([0,aB,mZ],1)});case
...
x=aU[1];throw g([0,bP,G(e(m8),x,j)],1)}var
o=c6(j,w),p=o[2],m=o[1];if(p!==aC[1]){var
y=aC[1];throw g([0,cr,bI(e(m9),j,p,y)],1)}if(1-c7(v,m)){var
z=aI[1];aI[1]=[0,l(e(m_),j),z]}var
A=c8(b,m);aH[1]=[0,A,aH[1]];aC[1]=m;aU[1]=aU[1]+1|0;i=n;continue;case
8:var
q=b[1],k=q[2],d=q[1],B=b[3],C=b[2],D=c5(d),u=h2(k,d);if(1-D){var
E=aU[1];throw g([0,bP,G(e(m$),E,d)],1)}if(1-u)throw g([0,bP,G(e(na),d,k)],1);if(k>=d){var
h=d;for(;;){var
r=c6(h,C),s=r[2],t=r[1];if(s!==aC[1]){var
H=aC[1];throw g([0,cr,bI(e(nb),h,s,H)],1)}if(1-c7(B,t)){var
I=aI[1];aI[1]=[0,l(e(nc),h),I]}aC[1]=t;var
J=h+1|0;if(k===h)break;h=J}}var
F=c8(b,aC[1]);aH[1]=[0,F,aH[1]];aU[1]=k+1|0;i=n;continue}throw g([0,aB,m7],1)}}throw g([0,aB,ms],1)});case
4:var
...
b=a4(m),j=a4(a);if(j<b)throw g([0,gg,G(e(nd),b,j)],1);var
h=c2(f);function
...
nf(a,b,c){if(0!==b[0])return gm(a,b[1],function(a){return l(c,a)},function(a){throw g([0,aB,nh],1)});var
d=b[1],h=b[2],f=cv(b[3]),i=f[1];if(f[2]){var
j=aI[1];aI[1]=[0,l(e(ng),d),j]}ar(b7,d,[0,h,i]);return l(c,a)}function
ey(a){var
b=fz(F(a)),e=F(a)-1|0,g=0;if(e>=0){var
d=g;for(;;){var
c=a1(a,d);a:if(34===c)a8(b,ni);else{if(14<=c){if(92===c){a8(b,nj);break a}}else if(9<=c)switch(c-9|0){case
0:a8(b,nk);break a;case
1:a8(b,nl);break a;case
4:a8(b,nm);break a}fC(b,c)}var
f=d+1|0;if(e===d)break;d=f}}return fA(b)}function
gn(a,b,c){var
d=b0(no,aA(function(a){var
b=ey(a);return l(e(nn),b)},b)),f=l(e(np),d),g=ey(c),h=ey(a),i=bI(e(nq),h,f,g);return l(e(nr),i)}function
bF(a){var
b=aI[1];aI[1]=0;return gn(ns,b,a)}function
nt(a){var
...
y=b7[2].length-1,I=b7[2];if(0<=y&&(I.length-1-y|0)>=0){nI(I,0,y,0);break a}aP(iL)}var
T=function(a,b,c){if(!b)return l(c,a);var
d=b[2];return nf(a,b[1],function(a){return T(a,d,c)})},ak=b0(nv,T(bA(0,10),ah,function(a){aH[1]=cV(aH[1]);return aH[1]})),al=cV(aI[1]);aI[1]=0;var
am=gn(ak,al,nw);return am}catch(f){var
d=a2(f);if(d===fR){var
H=c[12],ai=(H[4]-H[3]|0)+1|0,aj=H[2];return bF("SyntaxError: "+G(e(nu),aj,ai))}if(d[1]===i)return bF("TypeError: "+d[2]);if(d[1]===gf)return bF("DivideByZeroError: "+d[2]);if(d[1]===bP)return bF("RowNumberError: "+d[2]);if(d[1]===et)return bF("StitchError: "+d[2]);if(d[1]===cr)return bF("StitchCountError: "+d[2]);if(d[1]===gg)return bF("ForLoopError: "+d[2]);if(d[1]===ea)return bF("Error: "+d[2]);throw g(d,0)}}var
cw={compile:ok(function(a,b){return d4(nt(aD(b)))})},la=aD(typeof
cw)==="function"?0<cw.length?e_(cw):cw:cw;oN.LoopyCompiler=la;ec(0);return}(globalThis));
